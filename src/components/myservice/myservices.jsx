        ...
        <div id="services" className="flex flex-col  h-screen w-full lg:mt-10  lg:pt-52 pt-24 items-center gap-10">
            ...
            <div className="flex flex-col gap-10 justify-between lg:h-3/6 lg:w-9/12 lg:flex-row w-full items-center md:px-16">
                ...
                <motion.div
                    ...
                    className="flex flex-col  h-full lg:w-3/12 w-10/12 p-5 gap-10 hover:ring-1 ring-rose-200 hover:shadow-black rounded-lg relative overflow-hidden">
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={scaleT ? {
                        ...
                        className="absolute size-6 bg-rose-200 lg:size-3 rounded-full bottom-1/2 left-1/2 z-0"></motion.div>
                    <img src="/website-ui-ux-icon.svg" alt="" className="size-8 z-20" />

                    <h2 className="text-xl font-semibold z-20">Web design</h2>

                    <div className="flex gap-2 items-center text-md text-gray-600 cursor-pointer z-20">
                        Read More
                        <motion.svg
                            animate={scaleT ? { x: [10, 0, 10], transition: { repeat: Infinity, duration: 1 } } : {}}
                            className="size-7" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M19 12H5M19 12L15 16M19 12L15 8" stroke="#111928" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round" />
                        </motion.svg>
                    </div>
                </motion.div>
                ...
                <motion.div
                    ...
                    <motion.div
                        ...
                        className="absolute bg-rose-200  size-6 lg:size-3 rounded-full bottom-1/2 left-1/2 z-0"></motion.div>
                    <img src="/website-ui-ux-icon.svg" alt="" className="size-8 z-10" />

                    <h2 className="text-xl font-semibold z-10">Web design</h2>

                    <div className="flex gap-2 items-center text-md text-gray-600 cursor-pointer z-10">
                        Read More
                        <motion.svg
