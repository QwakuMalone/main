        ...
        <div id="contact" className="h-screen w-full gap-10 lg:w-8/12 flex flex-col items-center lg:gap-10   ">
            ...
            <form  onSubmit={onSubmit} className="w-full h-9/12 flex flex-col gap-10 items-center" >
                <div className="w-full lg:h-1/12 flex flex-col items-center gap-5 lg:flex-row lg:gap-10">
                    <input className="w-10/12 lg:w-1/2 h-11/12 ring-1 bg-slate-50 rounded-md lg:text-lg p-5 " type="text" placeholder="Enter your name" required name="name" />

                    <input className="w-10/12 lg:w-1/2 h-11/12 ring-1 bg-slate-50 rounded-md lg:text-lg p-5 " type="email" placeholder="Enter your email" required name="email" />

                </div>
                <textarea name="message" id="" cols="10" className="ring-1 bg-slate-50 w-10/12 lg:w-full h-4/12 rounded-lg resize-none p-5 lg:text-lg" placeholder="Message" required ></textarea>
                ...
                <motion.button
                    ...
                    className="lg:px-8 px-6 py-5 bg-stone-800 text-white text-xl rounded-full flex gap-1 items-center lg:w-2/12 md:w-2/10 w-5/10">
                    Submit now <motion.svg
                        animate={hove ? { x: [5, 0, 5], transition: { repeat: Infinity } } : {}}
                        className=" size-6 " viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19 12H5M19 12L15 16M19 12L15 8" stroke=" #FFFFFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </motion.svg>
