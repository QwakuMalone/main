...
export default function About() {
  ...
  return (
    <motion.div
      ...
      id="about" className=" w-full h-screen  items-center md:w-10/12  lg:flex-row flex-col flex  lg:px-30 gap-10 md:px-10 " >
      <motion.div
        ref={aboutRef}
        initial={{ opacity: 0, y: 100 }}
        animate={inVeiwAbout ? { opacity: 1, y: 0 } : {}}
        transition={{ delay: 0.5, duration: 0.8 }}
        className=" md:w-4/12  lg:h-5/6 h-2/12 w-6/12 flex justify-center items-center -z-10 ">
        <img src="/jujutsu.jpg " alt="" className="object-contain w-10/12  rounded-2xl " />
      </motion.div>
      ...
      <motion.div
        ...
        animate={inVeiwAbout ? { opacity: 1, y: 0 } : {}}
        transition={{ delay: 0.5, duration: 0.8 }}
        className="lg:w-8/12 w-full  flex h-10/12 flex-col lg:pt-8 gap-10">
        ...
        <div className="h-2/3  flex flex-col gap-5 px-5 w-full md:px-10 lg:flex-row lg:items-center mt-20 md:mt-10">
          ...
          {/* EDUCATION */}
          <div className=" w-full lg:w-2/5 lg:h-10/12 lg:mt-14 ring-2 h-3/12 md:gap-10   rounded-lg flex flex-wrap lg:flex-col px-6  lg:pt-7 lg:gap-5 hover:shadow-black items-center">
          ...
          {/* PROJECTS */}
          <div className="lg:w-2/5 w-full ring-2 h-3/12 lg:h-10/12 lg:mt-14 rounded-lg flex md:gap-10 lg:flex-col items-center lg:p-8 lg:gap-5 px-6 py-4 gap-5 text-xl hover:shadow-black">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className=" size-6 md:size-10">
